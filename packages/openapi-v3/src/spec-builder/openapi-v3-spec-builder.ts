...
// If we agree to merge `@loopback/openapi-spec-builder` and `@loopback/openapi-v3`,
// I will change the module name here
// If they should be separate, then I will update the `@loopback/openapi-spec-builder`
// in the next PR, and delete this file
